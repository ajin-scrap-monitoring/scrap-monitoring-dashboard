...
공장 관리자가 스크랩 적재 상태와 운영 정보를 확인하는 브라우저 대시보드의 프론트엔드
Repository다.
...
프로젝트 문서와 분리된 기술 학습 자료는 [`learning/README.md`](learning/README.md)에서
확인한다. 이 자료는 현재 프론트엔드 기반의 동작을 설명하며 프로젝트 결정의
정본으로 사용하지 않는다.
